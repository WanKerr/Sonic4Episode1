...
namespace Discord
{
    ...
    public partial struct LobbyTransaction
    {
        ...
        internal FFIMethods? MethodsStructure;
    ...
    public partial class DiscordPresence : IDisposable
    {
        [StructLayout(LayoutKind.Sequential)]
        ...
        private static partial Result DiscordCreate(UInt32 version, ref FFICreateParams createParams, out IntPtr manager);
        ...
        private FFIMethods? MethodsStructure;
        ...
        public DiscordPresence(Int64 clientId, UInt64 flags)
        {
    ...
    public partial class UserManager
    {
        ...
        {
            GCHandle h = GCHandle.FromIntPtr(ptr);
            DiscordPresence d = (DiscordPresence)h.Target;
    ...
    public partial class ActivityManager
    {
        ...
        FFIMethods.UpdateActivityCallback g_updateActivityCallback = UpdateActivityCallbackImpl;

        public void UpdateActivity(Activity activity, UpdateActivityHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped), g_updateActivityCallback);
        }
