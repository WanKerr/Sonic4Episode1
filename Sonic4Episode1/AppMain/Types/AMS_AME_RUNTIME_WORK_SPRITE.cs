...
public partial class AppMain
{
    public struct AMS_AME_RUNTIME_WORK_SPRITE
    {
        ...
        {
            get => BitConverter.ToSingle(this.rtm_work_.dummy, Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes + 4);
            set
            {
        ...
        {
            get => BitConverter.ToSingle(this.rtm_work_.dummy, Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes + 8);
            set
            {
        ...
        public int tex_no
        {
            get => BitConverter.ToInt32(this.rtm_work_.dummy, Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes + 12);
            set
            {
        ...
        public static explicit operator AMS_AME_LIST(
          AMS_AME_RUNTIME_WORK_SPRITE work)
        {
