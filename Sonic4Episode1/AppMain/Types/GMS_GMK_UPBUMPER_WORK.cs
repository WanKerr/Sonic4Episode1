public partial class AppMain
{
    ...
    {
        public readonly GMS_ENEMY_3D_WORK gmk_work = new GMS_ENEMY_3D_WORK();
        public int obj_type;
        ...
        public static explicit operator GMS_ENEMY_3D_WORK(GMS_GMK_UPBUMPER_WORK p)
        {
            return p.gmk_work;
        }
