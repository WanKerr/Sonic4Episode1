...
{
    public class GMS_BOSS3_MGR_WORK : IOBS_OBJECT_WORK
    {
        public readonly GMS_ENEMY_3D_WORK ene_3d;
        public int life;
        public uint flag;
        public GMS_BOSS3_BODY_WORK body_work;
        ...
        public static explicit operator OBS_OBJECT_WORK(GMS_BOSS3_MGR_WORK p)
        {
