...
public partial class AppMain
{
    public struct AMS_AME_RUNTIME_WORK_MODEL
    {
        ...
        public AMS_AME_RUNTIME_WORK_MODEL(AMS_AME_RUNTIME_WORK rtm_work)
        {
            ...
            this.color_ = new AMS_RGBA8888_Buf(rtm_work.dummy, Vector4D_Buf.SizeBytes + Vector4D_Buf.SizeBytes);
        }
        ...
        {
            get => BitConverter.ToSingle(this.rtm_work_.dummy, Vector4D_Buf.SizeBytes + Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes);
            set
            {
                int offset = Vector4D_Buf.SizeBytes + Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes;
        ...
        {
            get => BitConverter.ToSingle(this.rtm_work_.dummy, Vector4D_Buf.SizeBytes + Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes + 4);
            set
            {
                int offset = Vector4D_Buf.SizeBytes + Vector4D_Buf.SizeBytes + AMS_RGBA8888_Buf.SizeBytes + 4;
                MppBitConverter.GetBytes(value, this.rtm_work_.dummy, offset);
            }
        }

        public static explicit operator AMS_AME_LIST(
          AMS_AME_RUNTIME_WORK_MODEL work)
        {
