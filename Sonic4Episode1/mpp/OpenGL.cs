...
namespace mpp
{
  public sealed class OpenGL
  {
    ...
    private static readonly Matrix PROJECTION_CORRECTION = Matrix.CreateRotationZ(1.570796f) * Matrix.CreateScale(1f, 1.12f, 0.5f) * Matrix.CreateTranslation(0.0f, 0.0f, 0.5f);
    ...
    {
      OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].BoundTexture = texture;
    }
    ...
    public static void glDeleteBuffers(int n, uint[] buffers)
    {
      for (int index = 0; index < n; ++index)
      {
        ...
        OpenGL.m_usedBufferIDs[(int)num2] &= ~num3;
      }
    }
    ...
    public static void glDeleteTextures(int n, uint[] textures)
    {
      for (int index = 0; index < n; ++index)
      {
        ...
        uint num2 = num1 / 32U;
        uint num3 = 1U << (int) (num1 & 31U);
        OpenGL.m_usedTexIDs[(int)num2] &= ~num3;
      }
    }
    ...
    {
      OpenGL.glDepthMask((byte) 0 != flag);
    }
    ...
    public static void glDisable(uint cap)
    {
      switch (cap)
      {
        ...
        case 3058:
          ...
          break;
        case 3553:
          OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].Enabled = false;
          break;
        case 16384:
    ...
    public static void glEnable(uint cap)
    {
      switch (cap)
      {
        ...
        case 3058:
          ...
          break;
        case 3553:
          OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].Enabled = true;
          break;
        case 16384:
    ...
    public static void glDisableClientState(uint cap)
    {
      switch (cap)
      {
        ...
        case 32886:
          ...
          break;
        case 32888:
          OpenGL.m_textureUnits[(int)OpenGL.m_clientActiveTextureUnit].TexCoordArrayEnabled = false;
          break;
        case 33886:
    ...
    public static void glEnableClientState(uint cap)
    {
      switch (cap)
      {
        ...
        case 32886:
          ...
          break;
        case 32888:
          OpenGL.m_textureUnits[(int)OpenGL.m_clientActiveTextureUnit].TexCoordArrayEnabled = true;
          break;
        case 33886:
...
label_13:
    ...
    public static void glDrawElements(uint mode, int count, uint type, ushort[] indices)
    {
      ...
      if (OpenGL.m_textureUnits[0].TexCoordArrayEnabled && OpenGL.m_textureUnits[0].Enabled || buffer2.vertices == null)
      {
        ...
        {
          useVB = OpenGL.m_matrixPalleteOESEnabled || count > 32;
    ...
    public static void glGenBuffer(out uint buffer)
    {
      uint num1 = 0;
      uint num2 = 0;
      while (uint.MaxValue == OpenGL.m_usedBufferIDs[(int)num2])
      {
        ++num2;
        if ((long) num2 == (long) OpenGL.m_usedBufferIDs.Length)
          Array.Resize<uint>(ref OpenGL.m_usedBufferIDs, (int) num2 + 8);
      }
      uint num3 = 1;
      uint num4 = 0;
      while (num3 != 0U)
      {
        if (((int) OpenGL.m_usedBufferIDs[(int)num2] & (int) num3) == 0)
        {
          OpenGL.m_usedBufferIDs[(int)num2] |= num3;
    ...
    public static void glGenTexture(out uint texture)
    {
      uint num1 = 0;
      uint num2 = 0;
      while (uint.MaxValue == OpenGL.m_usedTexIDs[(int)num2])
      {
        ++num2;
        if ((long) num2 == (long) OpenGL.m_usedTexIDs.Length)
          Array.Resize<uint>(ref OpenGL.m_usedTexIDs, (int) num2 + 8);
      }
      uint num3 = 1;
      uint num4 = 0;
      while (num3 != 0U)
      {
        if (((int) OpenGL.m_usedTexIDs[(int)num2] & (int) num3) == 0)
        {
          OpenGL.m_usedTexIDs[(int)num2] |= num3;
          uint key = (uint) ((int) num2 * 32 + (int) num4 + 1);
          num1 = key;
    ...
    public static void glLightfv(uint light, uint pname, ref OpenGL.glArray4f param)
    {
      ...
      switch (pname)
      {
        case 4608:
          break;
        case 4609:
          OpenGL.m_lightUnit[(int)light].DiffuseColor.X = param.f0;
          OpenGL.m_lightUnit[(int)light].DiffuseColor.Y = param.f1;
          OpenGL.m_lightUnit[(int)light].DiffuseColor.Z = param.f2;
          break;
        case 4610:
          OpenGL.m_lightUnit[(int)light].SpecularColor.X = param.f0;
          OpenGL.m_lightUnit[(int)light].SpecularColor.Y = param.f1;
          OpenGL.m_lightUnit[(int)light].SpecularColor.Z = param.f2;
          break;
        case 4611:
          break;
        case 4612:
          OpenGL.m_lightUnit[(int)light].Direction.X = param.f0;
          OpenGL.m_lightUnit[(int)light].Direction.Y = param.f1;
          OpenGL.m_lightUnit[(int)light].Direction.Z = param.f2;
          break;
        default:
          throw new NotImplementedException();
      }
    ...
    public static void glLoadIdentity()
    {
      ...
      {
        OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES] = Matrix.Identity;
      }
      else
      {
    ...
    public static void glLoadMatrixf(ref Matrix matrix)
    {
      if (OpenGL.m_matrixPaletteOESActive)
      {
        OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES] = matrix;
      }
      else
      {
        OpenGL.m_activeMatrixStack.Pop();
    ...
    public static void glMatrixMode(uint mode)
    {
      ...
      switch (mode)
      {
        ...
        case 5889:
          ...
          break;
        case 5890:
          OpenGL.m_activeMatrixStack = OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].MatrixStack;
          break;
        case 6144:
          throw new NotImplementedException();
        case 34880:
      ...
      float farVal)
    {
      ...
      if (OpenGL.m_matrixPaletteOESActive)
        OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES] = orthographicOffCenter * OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES];
      else
    ...
    public static void glScalef(float x, float y, float z)
    {
      ...
      if (OpenGL.m_matrixPaletteOESActive)
        OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES] = scale * OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES];
      else
    ...
    public static void glTexCoordPointer(
      ...
      OpenGL.GLVertexData pointer)
    {
      OpenGL.TextureUnit textureUnit = OpenGL.m_textureUnits[(int)OpenGL.m_clientActiveTextureUnit];
    ...
    {
      OpenGL.m_textures[OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].BoundTexture] = texture;
      OpenGL.m_textures[OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].BoundTexture].Tag = (object) true;
    }
    ...
    public static void mppglTexImage2D(string textureName)
    {
      ...
      {
        OpenGL.m_textures[OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].BoundTexture] = Texture2D.FromStream(OpenGL.m_graphicsDevice, stream);
        OpenGL.m_textures[OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].BoundTexture].Tag = (object) true;
      }
    }
    ...
    public static void glTexParameteri(uint target, uint pname, int param)
    {
      if (target != 3553U)
        throw new NotImplementedException();
      TextureAddressMode AddrU = OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].SamplerState.AddressU;
      TextureAddressMode AddrV = OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].SamplerState.AddressV;
      switch (pname)
      {
        case 10242:
          switch (param)
      ...
      {
        samplerState = OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].SamplerState.clone();
        samplerState.AddressU = AddrU;
        samplerState.AddressV = AddrV;
        OpenGL.m_samplerStates[key] = samplerState;
      }
      OpenGL.m_textureUnits[(int)OpenGL.m_activeTextureUnit].SamplerState = samplerState;
    }
    ...
    public static void glTranslatef(float x, float y, float z)
    {
      ...
      if (OpenGL.m_matrixPaletteOESActive)
        OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES] = translation * OpenGL.m_matrixPalleteOES[(int)OpenGL.m_currentPaletteMatrixOES];
      else
    ...
    public static void init(Game game, GraphicsDevice graphicsDevice)
    {
      ...
      OpenGL.calculateInvScreenMatrix();
      int index1 = OpenGL.CalcDepthStencilStateId(OpenGL.m_depthStencilState.DepthBufferFunction, OpenGL.m_depthStencilState.DepthBufferWriteEnable);
      OpenGL.m_depthStencils[index1] = OpenGL.m_depthStencilState;
      int index2 = OpenGL.CalcSamplerStateId(OpenGL.m_textureUnits[0].SamplerState.AddressU, OpenGL.m_textureUnits[0].SamplerState.AddressV);
      OpenGL.m_samplerStates[index2] = OpenGL.m_textureUnits[0].SamplerState;
      long index3 = OpenGL.CalcBlendStateId(OpenGL.m_blendState.ColorSourceBlend, OpenGL.m_blendState.AlphaSourceBlend, OpenGL.m_blendState.ColorDestinationBlend, OpenGL.m_blendState.AlphaDestinationBlend, OpenGL.m_blendState.ColorWriteChannels, OpenGL.m_blendState.ColorBlendFunction, OpenGL.m_blendState.AlphaBlendFunction);
      OpenGL.m_blendStates[index3] = OpenGL.m_blendState;
    }
